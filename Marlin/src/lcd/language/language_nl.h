...
namespace LanguageNarrow_nl {
  ...
  LSTR MSG_RELEASE_SD                     = _UxGT("SD kaart uitwerpen");
  ...
  LSTR MSG_ZPROBE_SETTINGS                = _UxGT("Z sensor instellingen");
  LSTR MSG_ZPROBE_XOFFSET                 = _UxGT("X comp.");
  LSTR MSG_ZPROBE_YOFFSET                 = _UxGT("Y comp.");
  LSTR MSG_ZPROBE_ZOFFSET                 = _UxGT("Z sensor comp.");
  LSTR MSG_ZPROBE_OFFSET_N                = _UxGT("@ comp.");
  LSTR MSG_BABYSTEP_PROBE_Z               = _UxGT("Babystap Z sensor");
  ...
  //
  LSTR MSG_ADVANCED_PAUSE_WAITING         = _UxGT(MSG_2_LINE("Druk op knop om", "door te gaan"));
...
namespace LanguageTall_nl {
  using namespace LanguageWide_nl;
    ...
    LSTR MSG_FILAMENT_CHANGE_RESUME       = _UxGT(MSG_2_LINE("De print wordt", "hervat"));
  #endif

  LSTR MSG_PROBE_WIZARD                   = _UxGT("Z sensor comp. meten");
  LSTR MSG_PROBE_WIZARD_PROBING           = _UxGT("Voorbereiden...");
  LSTR MSG_PROBE_WIZARD_MOVING            = _UxGT("Verplaatsen...");
}
