...
//#define CASE_LIGHT_ENABLE
  ...
  #define CASE_LIGHT_PIN 4                  // Override the default pin if needed // Frits Sijbel
...
// When the axis is already at the endstop, move the axis until released. Best used in combination with a bump
#define HOMING_ALLOW_MOVE_AWAY
 ...
 */
  ...
  #define PROBE_OFFSET_WIZARD
    ...
    #define PROBE_OFFSET_WIZARD_XY_POS { LOGICAL_TO_NATIVE(X_CENTER, X_AXIS), LOGICAL_TO_NATIVE(Y_CENTER, Y_AXIS) }
  #endif
#endif
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  // Need to disable software endstops, otherwise X will move to logical X0
  // when doing the Y move
 ...
 */
  ...
  #define MESH_MIN_X LOGICAL_TO_NATIVE(0, X_AXIS)
  #define MESH_MAX_X LOGICAL_TO_NATIVE(X_BED_SIZE, X_AXIS)
  #define MESH_MIN_Y LOGICAL_TO_NATIVE(0, X_AXIS)
  #define MESH_MAX_Y LOGICAL_TO_NATIVE(Y_BED_SIZE, X_AXIS)
#endif
...
#define ADVANCED_PAUSE_FEATURE
  ...
  // Custom option to make the filament change menu the pause menu, since with
  // manual loading they pretty much do the same (the filament menu allows you
  // to turn on the extruder heater again). Also removes the filament change
  // menu from the main menu
  #define FILAMENT_CHANGE_IS_PAUSE_MENU
#endif
