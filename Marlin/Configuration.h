...
#define STRING_CONFIG_H_AUTHOR "Harm Berntsen" // Original author or contributor.
...
#define CUSTOM_MACHINE_NAME "Metzoprinter"
...
#define Z_CLEARANCE_DEPLOY_PROBE_INCLUDES_PROBE_OFFSET // The clearance above already takes the probe height into account
#define Z_CLEARANCE_BETWEEN_PROBES  5 // (mm) Z Clearance between probe points
#define Z_CLEARANCE_BETWEEN_PROBES_RELATIVE // The clearance above is relative to the previous probe in the series
...
// no sanity check because our Z-axis endstop varies per printer
#define Z_PROBE_DEFAULT_SANITY_CHECK false // Check for early/late probes by
                                           // default?
...
// Disable home offsets min/max
#define DISABLE_M428_LIMITS
...
// Numbers are before setting home offsets, the maximum distance from the end
// stop without the print head bumping into something.
// Measured on Harm's printer
...
#define HOMING_FEEDRATE_MM_M { (50*60), (50*60), (300) }
 ...
 */
#define NUM_SERVOS 0 // Note: Servo index starts with 0 for M280-M282 commands   // Bart Venneker
